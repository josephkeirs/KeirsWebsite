...
"/projects/carphone-warehouse-scrimpers/thumb7.mp4",
...

  {
    ...
    cats: ["Advertising"],
    type: "vimeo",
    thumb: "/projects/stella-journey/stella-journey-grid.jpeg",
    vimeoId: "914403621",
...

{
...

 {
...

  {
    ...
    cats: ["Advertising"],
    type: "vimeo",
    thumb: "/projects/absolut-born-to-mix-fashion/thumb.mp4", // ✅ your loop file (now supported)
    vimeoId: "1157415405",
  ...
  app.innerHTML = `
    <div class="topbar">
      <div class="topbar-inner">
        <button class="brandName brandBtn" type="button" id="brandBtn">JOSEPH KEIRS</button>
  ...
  return `
    <div class="drawerBackdrop" onclick="closeInfo()">
      <div class="drawer" onclick="event.stopPropagation()">
        ...
        <p>
          <a href="mailto:YOUR_EMAIL_HERE">Email</a><br/>
          <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer">LinkedIn</a><br/>
